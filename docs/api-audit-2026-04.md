...
### M40. `api/process-entity-audit.js`, `api/generate-proposal.js`, `api/run-migration.js` — GitHub wrapper bypass
...
- **Medium:** 40 total (M1–M40; M39 added by Group F, M40 added by M7+M4 session during caller enumeration). **Resolved: 27** (M2, M4, M5, M6, M7, M8, M9, M10, M11, M12, M13, M14, M15, M16, M17, M18, M20, M22, M26, M27, M28, M30, M31, M33, M34, M36, M38). **Partial: 0** (M4 flipped 🔶 → ✅ via `87a4a5e8` allowlist). **Open: 13** (M1, M3, M19, M21, M23, M24, M25, M29, M32, M35, M37, M39, M40).
- **Low:** 29 total (L1–L29; L29 added by M7+M4 session as the Supabase top-line-string polish pass). **Resolved: 14** (L1, L6, L8, L10, L12, L14, L16, L17, L18, L20, L22, L26, L27-documented-only, L28). **Open: 15** (L2, L3, L4, L5, L7, L9, L11, L13, L15, L19, L21, L23, L24, L25, L29).
- **Nit:** 6 total (N1–N6). **Resolved: 5** (N1, N2, N3, N4, N6). **Open: 1** (N5).

**Total: 120 findings. Resolved: ≥90. Open: 30 (29 non-deferred + H29 deferred).**
