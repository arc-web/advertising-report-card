...
(function() {
  ...
  var CHAT_API = '/api/agreement-chat';
  var TOOLTIP_KEY = 'moonraker-agreement-tooltip-dismissed';
  var CHAT_OPEN_KEY = 'moonraker-agreement-chat-open';
  ...
  tooltip.innerHTML = '<button class="mpc-tooltip-close" id="mpcTooltipClose">&times;</button>' +
    ...
    '<div class="mpc-tooltip-text"><strong>Questions about the agreement?</strong><br>I can explain any section, clarify terms, walk you through what\'s included, or answer anything else. Just ask!</div>' +
    '</div>';
  ...
  btn.setAttribute('aria-label', 'Chat about the agreement');
  ...
  panel.innerHTML =
    ...
    '<div class="mpc-input-area">' +
      '<div class="mpc-input-wrap">' +
        '<textarea class="mpc-input" id="mpcInput" rows="1" placeholder="Ask about the agreement..."></textarea>' +
